...
val FILTER_PRESETS = listOf(
    ...
    FilterPreset(
        ...
        filterB = FilterBParams(highlightsTint = 0xFFE8DCCF.toInt(), shadowsTint = 0x101826.toInt(), strength = 0.18f)
    ),
    FilterPreset(
        id = "night",
    ...
    FilterPreset(
        ...
        filter = FilterParams(brightness = 0.05f, contrast = 1.0f, saturation = 1.05f),
        filterB = FilterBParams(highlightsTint = 0xFFFCE9C7.toInt(), shadowsTint = 0x000000.toInt(), strength = 0.25f)
    ),
    FilterPreset(
        id = "fog",
